...
export default function Footer() {
  return (
    <footer className="bg-secondary" aria-labelledby="footer-heading">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="flex flex-col bg-secondary ">
            <div class="flex justify-center">
              <img
                ...
                class="custom-logo filter brightness-0 invert mb-4"
                alt="Høyre"
              ></img>
            </div>
            <h2 class="footer-widget--title text-center text-blue_200 min-h-12 mb-4">
              KONTAKT OSS
            </h2>
            <div class="flex justify-center">
              <dl class="contact-details-wrapper flex flex-col justify-center ">
                <div class="flex mb-1">
                  <dt class="email mr-2">
                    <div class="w-6">
                      <svg
                  ...
                  <dd class="email">
                    <a href="mailto:info@hoyre.no" class="text-white">
                      info@hoyre.no
                    </a>
                  </dd>
                </div>
                ...
                <div class="flex mb-1">
                  ...
                  <dd class="phone">
                    <a href="tel:+4799999999" class="text-white">
                      (+47) 99999999
                    </a>
                  </dd>
                </div>
                ...
                <div class="flex mb-1">
                  ...
                  <dd class="address" class="text-white">
                    Skagenkaien 1 (3. etasje)
                  </dd>
                </div>
              </dl>
            </div>
              ...
              <ul class="flex">
                <li class="mx-2 mb-1">
                  <a href="https://facebook.com/hoyre">
                    <div class="bg-blue-800 rounded-full p-2">
                      ...
                      <svg
                        ...
                        width="30px"
                        height="30px"
                        class="custom-logo filter brightness-0 invert"
                      >
                        <path
          ...
          <div className="flex flex-col bg-secondary ">
            <div class="text-center mx-3">
              <h2 class="footer-widget--title text-center text-blue_200 min-h-12 mb-4">BLI MED</h2>
              <p class="text-white">
                <a href="https://hoyre.no/bli-med/bli-medlem/" class="text-white">
                  Bli medlem
                </a>
              </p>
              <p class="text-white">
                <a href="yohttps://hoyre.no/bli-med/gi-gave/" class="text-white">
                  Gi gave
                </a>
              </p>
            </div>
      ...
      <div class="p-5 bg-secondary_dark flex justify-center">
        <div class="text-center mx-3">
          <a href="https://hoyre.no/partiet/kontakt-oss/" class="text-white">
            <p class="text-white">@2023 Høyre</p>
          </a>
        </div>
        <div class="text-center mx-3">
          <a href="https://hoyre.no/personvernerklaering/" class="text-white">
            <p class="text-white">Personvernerklæring</p>
          </a>
        </div>
        <div class="text-center mx-3">
          <a href="https://hoyre.no/vilkar-fastgivere/" class="text-white">
            <p class="text-white">Vilkår Fastgivere</p>
          </a>
        </div>
      </div>
    </footer>
